...
public class ResultSummary
{
    ...
    public const int  ExpiryDatesAll       = 72;   // 6 years × 12 months
    ...
    public string Write()
    {
        ...
        sb.AppendLine($"  Space (full Track2)       : {Track2Full:N0}  (10^9 PAN × {ExpiryDatesAll} expiry × {ServiceCodes} service codes)");
        sb.AppendLine($"  Space (known expiry year) : {Track2KnownYear:N0}  (10^9 PAN × {ExpiryDatesKnownYear} months × {ServiceCodes} service codes)");
        sb.AppendLine();
